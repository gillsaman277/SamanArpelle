...
<title>Men Woollen Jackets</title>
</head>
  ...
  <div class="content_box">
			...
			<div class="row">
				...
				<div class=" col-lg-12 col-md-12" style="border-right:2px solid silver">
				   	      ...
				   	      <p ><h2 style="color:#000000; text-align:center">Filter By</h2></p>
...
rs=stmt.executeQuery("select * from subproduct where pcid=3"); 
while(rs.next())
{
	Integer price1=Integer.parseInt(rs.getString("price"));
	price1=price1+(price1*10)/100;
	String pcid1=rs.getString(2);
	pcid1=pcid1+1;
%>
 ...
 <div class="col-lg-3 col-md-3 item">
        <div class="pbox">
            <a class="aimg" href="moreinfo.jsp?pid=<%=rs.getString("pcid")%>"><img src="<%=rs.getString("pimgurl")%>" style=" border-radius:2px;" alt="Elegant evening Dress"></a>
           ...
           <a href="AddCart1?pid=<%=rs.getString("pcid")%>"> <button class="btn btn-primary" style="margin-top:10px;"><i class="fa fa-cart-plus">&nbsp; Add To Cart </i>  </button></a>
         </div></div>
