	...
	%>
			...
			<div class="right_content" >
				<div class="shopping_cart">
					...
					<div class="cart_icon">
						<a href="viewCart.jsp" title="header=[Checkout] body=[&nbsp;] fade=[on]"><img
								src="project images/shoppingcart.png" alt="" width="48" height="48"
								border="0" />
						</a>
					</div>
				</div>
				...
				<div class="border_box" >
					<div class="product_title"><a href="detail.jsp?pid=22">Kurti</a></div>
					<div class="product_img"><a href="detail.jsp?pid=22"><img src="project image\kurti\142858943762581056-black-stand-collar-embroidered-kurta-kurti.jpg" alt="Kurti" border="0" height="92" width="94" /></a></div>
					<div class="prod_price"><span class="reduce">23100 RS</span><span class="price"> 21100 RS</span></div>
				</div>
				<div class="title_box">Manufacturers
				</div>
				<ul class="left_menu">
        <li class="odd"><a href="#" target="new">Sony</a></li>
        <li class="even"><a href="#" target="new">Samsung</a></li>
        <li class="odd"><a href="#" target="new">Lenovo</a></li>
        <li class="even"><a href="#" target="new">LG</a></li>
        <li class="odd"><a href="#" target="new">Hp</a></li>
        <li class="even"><a href="#" target="new">Nokia</a></li>
        <li class="odd"><a href="#" target="new">Phillips</a></li>
        <li class="even"><a href="#" target="new">Nikon</a></li>
		<li class="odd"><a href="#" target="new">Canon</a></li>
		<li class="even"><a href="#" target="new">Apple</a></li>
		<li class="odd"><a href="#" target="new">Acer</a></li>
		<li class="even"><a href="#" target="new">Dell</a></li>
      </ul>
				<div class="banner_adds">
					<a href="#"><img src="project image/banner.jpg" alt="" border="0" />
					</a>
				</div>
			</div>
