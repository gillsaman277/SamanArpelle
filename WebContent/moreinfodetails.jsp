...
#description {float:right;width:500px;}
 ...
 <div class="container" style=" margin-top:10px" >
 	...
 	<div class="col-lg-12">
        ...
        <p class="text-center bg-primary" style="margin:10px; font-size:18px;">Rollover to zoom. <a href="#">Click to enlarge.</a></p>
...
<div id="description">
        ...
        <strong id="price"> <span> previously<i class="fa fa-inr"></i>  &nbsp;<%=rs.getString("price")%></span><i class="fa fa-inr">
		</i><%=rs.getString("price")%></strong><p><%=rs.getString("pdesc")%></p>
       
        <p>
        <a href="AddCart1?pid=<%=rs.getString(1)%>"><button type="submit" class="btn btn-success">Add To Cart &nbsp; <i class="fa fa-shopping-cart "></i></button></a></p>
