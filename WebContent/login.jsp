      			...
      			<div id="social-icons-conatainer">
	        		<div class="modal-body-left">
	        			<div class="form-group">
		              		<input type="text" id="username" name="emailId" placeholder="Enter your name" value="" class="form-control login-field">
		            	...
		            	<a href="fp.jsp" class="login-link text-center">Lost your password?</a>
	        		</div>
