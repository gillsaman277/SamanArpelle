...
<title>Men's Leather Jackets</title>
</head>
...
rs=stmt.executeQuery("select * from suit"); 
while(rs.next())
{
...
%>
 <div class="col-lg-3 col-md-3">
        <div class="pbox">
            <a class="aimg" href="moreinfo.jsp?pid=<%=rs.getString("pid")%>"><img src="<%=rs.getString("pimgurl")%>" style=" border-radius:2px;" alt="Elegant evening Dress"></a>
           ...
           <a href="AddCart1?pid=<%=rs.getString("pid")%>"> <button class="btn btn-primary" style="margin-top:10px;"><i class="fa fa-cart-plus">&nbsp; Add To Cart </i>  </button></a>
         </div></div>
