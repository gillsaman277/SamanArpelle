	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(valid)
		{
			session.setAttribute("admin_name",admin_name);
     		System.out.println("Name:::"+name  +"Path:::::"+request.getContextPath()+"/admin_select_product.jsp");
		...
		{
			out.println("<div style='position:absolute; top:350px; left:460px'><font color='red'><b>User Name and password are invalid</b></font></div>");
